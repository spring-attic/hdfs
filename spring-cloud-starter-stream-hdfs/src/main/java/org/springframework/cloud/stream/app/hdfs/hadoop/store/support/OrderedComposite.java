...
/**
 * Composite item which can be used in other components which may want to allow automatic
 * and annotation based ordering. Good use case is a list of listeners where user may want
