 ...
 */
package org.springframework.cloud.stream.app.hdfs.hadoop.store.config.annotation.configurers;

import org.springframework.cloud.stream.app.hdfs.hadoop.config.common.annotation.AnnotationConfigurer;
import org.springframework.cloud.stream.app.hdfs.hadoop.config.common.annotation.AnnotationConfigurerAdapter;
import org.springframework.cloud.stream.app.hdfs.hadoop.store.config.annotation.SpringDataStoreWriterConfigs;
import org.springframework.cloud.stream.app.hdfs.hadoop.store.config.annotation.builders.DataStoreTextWriterBuilder;
import org.springframework.cloud.stream.app.hdfs.hadoop.store.config.annotation.builders.DataStoreTextWriterConfigurer;
import org.springframework.cloud.stream.app.hdfs.hadoop.store.partition.DefaultPartitionStrategy;
