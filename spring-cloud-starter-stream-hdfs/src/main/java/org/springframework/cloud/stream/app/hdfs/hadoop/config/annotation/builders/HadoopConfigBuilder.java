...
import org.springframework.cloud.stream.app.hdfs.hadoop.config.common.annotation.configurers.DefaultPropertiesConfigurer;
import org.springframework.cloud.stream.app.hdfs.hadoop.config.common.annotation.configurers.DefaultResourceConfigurer;
import org.springframework.cloud.stream.app.hdfs.hadoop.config.common.annotation.configurers.DefaultSecurityConfigurer;
import org.springframework.cloud.stream.app.hdfs.hadoop.config.common.annotation.configurers.PropertiesConfigurer;
import org.springframework.cloud.stream.app.hdfs.hadoop.config.common.annotation.configurers.PropertiesConfigurerAware;
import org.springframework.cloud.stream.app.hdfs.hadoop.config.common.annotation.configurers.ResourceConfigurer;
import org.springframework.cloud.stream.app.hdfs.hadoop.config.common.annotation.configurers.ResourceConfigurerAware;
import org.springframework.cloud.stream.app.hdfs.hadoop.config.common.annotation.configurers.SecurityConfigurer;
import org.springframework.cloud.stream.app.hdfs.hadoop.config.common.annotation.configurers.SecurityConfigurerAware;
import org.springframework.cloud.stream.app.hdfs.hadoop.configuration.ConfigurationFactoryBean;
import org.springframework.cloud.stream.app.hdfs.hadoop.security.HadoopSecurity;
import org.springframework.cloud.stream.app.hdfs.hadoop.security.SecurityAuthMethod;
