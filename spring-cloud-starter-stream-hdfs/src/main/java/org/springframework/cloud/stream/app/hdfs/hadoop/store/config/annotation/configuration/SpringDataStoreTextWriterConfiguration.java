 ...
 */
package org.springframework.cloud.stream.app.hdfs.hadoop.store.config.annotation.configuration;
...
import org.springframework.cloud.stream.app.hdfs.hadoop.config.common.annotation.AbstractImportingAnnotationConfiguration;
...
import org.springframework.cloud.stream.app.hdfs.hadoop.store.config.annotation.EnableDataStorePartitionTextWriter;
...
import org.springframework.cloud.stream.app.hdfs.hadoop.store.support.LifecycleObjectSupport;
