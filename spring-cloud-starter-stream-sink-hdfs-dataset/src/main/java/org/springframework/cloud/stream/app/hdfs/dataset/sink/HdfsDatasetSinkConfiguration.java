...
import org.springframework.cloud.stream.app.hdfs.hadoop.store.StoreException;
import org.springframework.cloud.stream.app.hdfs.hadoop.store.dataset.DatasetDefinition;
import org.springframework.cloud.stream.app.hdfs.hadoop.store.dataset.DatasetOperations;
import org.springframework.cloud.stream.app.hdfs.hadoop.store.dataset.DatasetRepositoryFactory;
import org.springframework.cloud.stream.app.hdfs.hadoop.store.dataset.DatasetTemplate;
